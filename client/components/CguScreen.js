...
Les données à caractère personnel qui sont collectées par l'application sont les suivantes :
 ...
 - **communication :** lorsque l'application est utilisée pour communiquer avec d'autres membres, les données concernant les communications de l'utilisateur font l'objet d'une conservation temporaire ;
...
const CguScreen = props => {
  return (
    <ScreenWrapper {...props} style={{ marginBottom: 20 }}>
      <ScreenTitle label="Conditions générales d'utilisation de l'application" />
      <Markdown style={{
